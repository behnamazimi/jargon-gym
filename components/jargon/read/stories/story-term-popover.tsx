...
export function StoryTermPopover({ text, term }: { text: string; term: StoryTerm | undefined }) {
  ...
  return (
    <DialogTrigger>
      <AriaButton className="cursor-pointer rounded-sm font-medium underline decoration-primary/45 decoration-[1.5px] underline-offset-4 outline-none transition-colors hover:text-primary hover:decoration-primary focus-visible:ring-2 focus-visible:ring-primary/60">
        {text}
      </AriaButton>
      <Popover
        placement="bottom"
